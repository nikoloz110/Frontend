class Game {
  ...
  countDownThenLoop() {
    ...
    function drawTimer() {
      ...
      function countdown() {
        i--;
        this.board.clear();
        this.board.ctx.font = "100px Young-Light";
  ...
  drawScore() {
    ...
    this.board.ctx.fill();
    this.board.ctx.font = "30px Young-Light";
    this.board.ctx.fillText(`score: ${this.score}`, 10, 20);
  ...
  startScreen() {
    this.board.ctx.font = "40px Young-Light";
    if (!firstTimePlaying) {
      this.board.clear();
      this.board.ctx.fillText(
        "GAME OVER",
        this.board.width / 2 - 70,
